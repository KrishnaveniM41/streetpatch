...
class SuggestionPageState extends StatefulWidget {
  const SuggestionPageState({super.key});

  @override
  State<SuggestionPageState> createState() => _SuggestionPageState();
}

class _SuggestionPageState extends State<SuggestionPageState> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(' UPLOAD PHOTO :',
                        style: TextStyle(
                            color: Color.fromARGB(255, 212, 161, 177),
